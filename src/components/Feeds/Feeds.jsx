...
const FEED_DATA = [
  {
    ...
    feed: {
      ...
      caption:
        "Berakit ke hulu berenang renang ketepian, bersakit sakit dahulu bersenang senang dalam kesepian. Kerja keras, istirahat dan tidur yang cukup, dan banyak berdoa dan bersyukur.",
      totalComments: 3,
      comments: [
    ...
    feed: {
      ...
      comments: [
        ...
        },
        {
          id: "2",
          username: "Bob",
          text: "agreed! lorem ipsum dolor sit amet, this is a comment",
          profilePic: "https://randomuser.me/api/portraits/men/45.jpg",
          commentDate: Date.now() - 60 * 60 * 24 * 1000 * 130,
        },
        {
  ...
  },
  {
    ...
    feed: {
      ...
      caption:
        "Berakit rakit rakit ke hulu berenang renang ketepian, bersakit sakit dahulu bersenang senang dalam kesepian. Kerja keras, istirahat dan tidur yang cukup, dan banyak berdoa dan bersyukur.",
      totalComments: 3,
      comments: [
        // Menambahkan data komentar
        {
        ...
        },
        {
          id: "2",
          username: "Bob",
          text: "Great! lorem ipsum dolor sit amet, this is a comment",
          profilePic: "https://randomuser.me/api/portraits/men/45.jpg",
          commentDate: Date.now() - 60 * 60 * 24 * 1000 * 130,
        },
        {
