          ...
          <View style={{ flexDirection: "column", flexShrink: 1 }}>
            <View style={{ flexDirection: "row", gap: 5 }}>
              ...
              <Text style={{ fontSize: 12, color: "gray" }}>
                {getPostDateText(props.item.feed.postDate)}
              </Text>
            </View>
            <View style={{ flexDirection: "row", flexWrap: "wrap" }}>
              <Text style={{ fontWeight: "400" }}>{getDisplayText()}</Text>
              {expanded ? (
                <Text style={{ textAlign: "center" }} onPress={toggleExpanded}>
                  less
                </Text>
              ) : (
                <Text style={{ textAlign: "center" }} onPress={toggleExpanded}>
            ...
            >
              ...
              <View style={{ flexDirection: "column", flexShrink: 1 }}>
                <View style={{ flexDirection: "row", gap: 5 }}>
                  ...
                  <Text style={{ fontSize: 12, color: "gray" }}>
                    {getPostDateText(comment.commentDate)}
                  </Text>
                </View>
                <View style={{ flexDirection: "row" }}>
                  <Text style={{ fontWeight: "400" }}>{comment.text}</Text>
                </View>
              </View>
            </View>
